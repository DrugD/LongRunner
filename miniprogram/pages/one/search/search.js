...
Page({
  ...
  onLoad: function(val) {
    ...
    if (val.input_content) {
      console.log(val.input_content)
      wx.showLoading({
        title: '查询中...',
      })
      //手动输入地名 但时间也有没做要求
      wx.cloud.callFunction({
        ...
        data: {
          // "state": 1,
          province: val.input_content,
          city: val.input_content,
        }
      }).then(res => {
        console.log(res)
  ...
  query: function() {
    ...
    var that = this
    console.log(this.data.olddate, this.data.newdate)
    // console.log(this.data)
    // console.log(this.data.multiArray[0][this.data.multiIndex[0]], this.data.multiArray[1][this.data.multiIndex[1]])
    if (this.data.switchChecked1 && this.data.switchChecked2 == false && this.data.switchChecked3 == false) {
      // //只要地点对！
      ...
      wx.cloud.callFunction({
        ...
        if (res.result.data.length > 0) {
          ...
          // // var dataList = encodeURIComponent(JSON.stringify(Traces));
          // wx.redirectTo({
          //   url: '/pages/one/search/result?queryResult=' + res.result.data,

          // })
          // that.onLoad(res.result.data)



          //操他妈！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！马勒戈壁的傻逼玩意，非要先清空才能在赋值????????骂隔壁的不能直接赋值吗？？
          that.setData({
            queryResult: null,
          })
    ...
    } else if (this.data.switchChecked1 == false && this.data.switchChecked2 == true) {
      // //只要时间对！
      wx.cloud.callFunction({
        name: 'getChooseData2',
        data: {
          state: 2,
          olddate: that.data.olddate,
          newdate: that.data.newdate,
    ...
    } else if (this.data.switchChecked1 == false && this.data.switchChecked2 == false && this.data.switchChecked3 == false) {
      //时间地点都要限制
      console.log("this时间地点都要限制")
      wx.cloud.callFunction({
        name: 'getChooseData3',
        data: {
    ...
    } else if (this.data.switchChecked3 && this.data.switchChecked1 == false) {
      //手动输入地名且时间也有限制
      console.log("now is ")
      wx.cloud.callFunction({
        name: 'getChooseData3',
    ...
    } else if (this.data.switchChecked3 && this.data.switchChecked1) {
      //手动输入地名 但时间也有没做要求
      wx.cloud.callFunction({
        name: 'getChooseData',
        data: {
  ...
  switchChange1: function() {
    this.setData({
      switchChecked1: !this.data.switchChecked1
    })
    console.log(this.data.switchChecked1)
  },

  switchChange2: function() {
    this.setData({
      switchChecked2: !this.data.switchChecked2
    })
    console.log(this.data.switchChecked2)
  },

  switchChange3: function() {
    this.setData({
      switchChecked3: !this.data.switchChecked3,
      input_flag: !this.data.input_flag,
    })
    console.log(this.data.switchChecked3)
  },
